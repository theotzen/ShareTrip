...
client = mongo_client.MongoClient(
    settings.DATABASE_URL_CHATAPP, serverSelectionTimeoutMS=5000)

try:
    loggerIH.info(settings.DATABASE_URL_CHATAPP)
...
db = client[settings.MONGO_INITDB_DATABASE_CHATAPP]
Message = db.messages
