...
async def get_trajet(trajet_id: str, cookies: dict = None, base_url: str = base_url, endpoint: str = '/api/trajets/getTrajet/{trajet_id}'):
	try: 
		res = await client.get(url=base_url+endpoint+ '/'+trajet_id) 
	except httpx.HTTPError as err: 
		raise SystemExit(err)
	return res.json()
...
async def delete_trajet(trajet_id: str, cookies: dict = None, base_url: str = base_url, endpoint: str = '/api/trajets/deleteTrajet/{trajet_id}'):
	try: 
		res = await client.delete(url=base_url+endpoint+ '/'+trajet_id) 
	except httpx.HTTPError as err: 
		raise SystemExit(err)
	return res.json()